...
local strings = {
	...
	HR_MENU_HORN_SHARE_TT = "Invia la tua % abilità finale ai membri del gruppo (solo quando il corno da guerra è inserito).",
	...
	HR_MENU_ICONS_README1 = "Per vedere in anteprima un'icona personalizzata qui sotto, deve avere l'estensione .dds (formato file DirectDraw Surface). La dimensione preferibile è 32x32 px.",
	HR_MENU_ICONS_README2 = "Se vuoi che gli altri giocatori vedano la tua icona, allora devi sostenere l'autore dell'addon |cFFFF00@andy.s|r con oro (anche le donazioni in denaro reale sono benvenute).\nIcona statica: |cFFFF002M oro|r, icona animata: |cFFFF004M oro|r. Puoi contattare l'autore tramite Discord (|cFFFF00andy.s#2135|r) o il sito esoui.com.",
	HR_MENU_ICONS_README3 = "Puoi vedere in anteprima il tuo nome e l'icona qui sotto e inviare il codice LUA generato insieme al file dell'icona a |cFFFF00andy.s#2135|r via Discord (mandami prima una richiesta di amicizia).",
