local strings = {
	...
	HR_MENU_ICONS_README1 = "Иконка должна быть в формате .dds (DirectDraw Surface) и иметь размер 32x32 пикселя.",
	HR_MENU_ICONS_README2 = "Чтобы другие игроки увидели вашу иконку, необходимо поддержать автора |cFFFF00@andy.s|r золотом. Обычная иконка: |cFFFF002 миллиона золотых|r, анимированная: |cFFFF004 миллиона|r. Связаться можно через Discord (|cFFFF00andy.s#2135|r) или сайт esoui.com",
