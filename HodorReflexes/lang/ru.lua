local strings = {
	...
	HR_MENU_HORN_SHARE_TT = "Отправлять процент готовности моего горна другим членам группы, если он есть на панели способностей.",
	...
	HR_MENU_ICONS_README1 = "Иконка должна быть в формате .dds (DirectDraw Surface). Рекомендуемый размер 32x32 пикселя.",
	HR_MENU_ICONS_README2 = "Чтобы другие игроки увидели вашу иконку, необходимо поддержать автора |cFFFF00@andy.s|r золотой монетой. Обычная иконка: 1 миллион золота, анимированная: от 2 до 3 миллионов в зависимости от количества кадров. Связаться можно через Discord (|cFFFF00andy.s#2135|r) или сайт esoui.com",
	HR_MENU_ICONS_README3 = "Ниже можно посмотреть, как будут выглядеть ваше имя и иконка. Отправьте сгенерированный LUA код вместе с файлом иконки через Discord |cFFFF00andy.s#2135|r (потребуется добавить меня в друзья).",
